...
mixin _$Expertise {
  ...
  /// Serializes this Expertise to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of Expertise
...
class _$ExpertiseImpl implements _Expertise {
  ...
  @override
  String toString() {
    return 'Expertise(id: $id, title: $title, icon: $icon, description: $description, tags: $tags)';
  }
...
abstract class _Expertise implements Expertise {
  const factory _Expertise(
      ...
      required final List<String> tags}) = _$ExpertiseImpl;
